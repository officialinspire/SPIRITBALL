...
- A dev-only continuous-collision-detection code path silently falls back to a weaker safety net
  because the Havok API it expects doesn't exist in the currently vendored version.
